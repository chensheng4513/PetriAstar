...
public class conflictPlaceSet {
    ...
    public String deadlockType;//冲突类型
    public Token conflictTokenA;//冲突的两个托肯之一，tokenA
    public Token conflictTokenB;//冲突的两个托肯之一，tokenB

    public conflictPlaceSet(ArrayList<Place> placeSet, String conflictType, String deadlockType ,Token conflictTokenA, Token conflictTokenB) {
